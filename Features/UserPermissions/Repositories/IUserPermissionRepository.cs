...
namespace LMS_SoulCode.Features.UserPermissions.Repositories
{
    public interface IUserPermissionRepository
    {
        ...
        Task RemoveRoleFromUserAsync(int userId, int roleId, int? tenantId, CancellationToken cancellationToken = default);
        ...
        Task<bool> UserRoleExistsAsync(int userId, int roleId, int? tenantId, CancellationToken cancellationToken = default);
        Task UpdateUserRoleAsync(int userId, int oldRoleId, int? oldTenantId, int newRoleId, int? newTenantId, CancellationToken cancellationToken = default);
        Task<Common.ApiResponse<List<string>>> UpdateUserRoleStatusAsync(int userId, int roleId, bool isActive, int? tenantId, CancellationToken cancellationToken = default);
