...
namespace LMS_SoulCode.Features.UserPermissions.Repositories
{
    public interface IModuleRepository : IBaseRepository<Module>
    {
        ...
        Task LinkPermissionsAsync(int moduleId, List<int> permissionIds, int? tenantId, CancellationToken cancellationToken = default);
        ...
        Task<List<GetPermissionDto>> GetModulePermissionsAsync(int moduleId, CancellationToken cancellationToken = default);
    }
}
