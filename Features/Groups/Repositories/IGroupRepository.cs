...
namespace LMS_SoulCode.Features.Groups.Repositories
{
    public interface IGroupRepository : IBaseRepository<Group>
    {
        ...
        Task<(IEnumerable<GroupCourseDto> Items, int TotalCount)> GetGroupCoursesPagedByGroupIdAsync(int groupId, int? tenantId, string? searchTerm, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
