        ...
        public async Task SeedAsync()
        {
            ...
            await strategy.ExecuteAsync(async () =>
            {
                ...
                try
                {
                    ...
                    // 5. Insert Roles
                    var superAdminRole = new Role { Name = "Super Admin", Code = "SUPER_ADMIN", IsActive = true, TenantId = null, IsDefault = true };
                    var orgAdminRole = new Role { Name = "Organization Admin", Code = "ORGANIZATION_ADMIN", IsActive = true, TenantId = null, IsDefault = true };
                    var instructorRole = new Role { Name = "Instructor", Code = "INSTRUCTOR", IsActive = true, TenantId = null, IsDefault = true };
                    var studentRole = new Role { Name = "Student", Code = "STUDENT", IsActive = true, TenantId = null, IsDefault = true };
