...
namespace LMS_SoulCode.Features.UserPermissions.Controllers
{
    ...
    public class UserPermissionsController : BaseApiController
    {
        ...
        [BackOfficePermission(ModuleCodes.USER_PERMISSION, PermissionCodes.ROLE_ASSIGN)]
        ...
        [BackOfficePermission(ModuleCodes.USER_PERMISSION, PermissionCodes.USER_PERMISSION_ASSIGN)]
