...
namespace LMS_SoulCode.Features.UserPermissions.Repositories
{
    public interface IUserPermissionRepository
    {
        ...
        Task AssignPermissionsAsync(AssignPermissionDto dto, CancellationToken cancellationToken = default);
        Task<List<UserPermissionDto>> GetUserPermissionsAsync(int userId, CancellationToken cancellationToken = default);
        Task<bool> CheckUserPermissionAsync(int userId, string moduleCode, string permissionCode, CancellationToken cancellationToken = default);
        ...
        Task<List<UserPermissionDto>> GetRoleModulePermissionsAsync(int roleId, int moduleId, CancellationToken cancellationToken = default);
